...
var c = [
  ...
  u = { version: e, total: c.length },
  g = ({ subject: o, color: t, logo: r, logoColor: i }) =>
    `https://img.shields.io/badge/${encodeURIComponent(
      o,
    )}-${t}?style=flat-square&logo=${encodeURIComponent(r)}&logoColor=${i}`,
  l = {
...
export { a as badges, c as icons, u as info };
